...
MethodInstance for Main.workspace#4.double(::Dict{Symbol, AbstractFloat}, ::Symbol)
  from double(mapping, key::Symbol) in Main.workspace#4 at /home/runner/work/julia/julia/tutorials/benchmarking.jl#==#3f0e2049-8597-4dac-b499-4d7a8a35978e:1
Arguments
...
BenchmarkTools.Trial: 10000 samples with 991 evaluations.
 Range (min … max):   40.363 ns … 20.265 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):      42.179 ns              ┊ GC (median):    0.00%
 Time  (mean ± σ):   118.571 ns ±  1.028 μs  ┊ GC (mean ± σ):  1.81% ± 1.69%

       █▂                                                       
  ▂▃▃▄▆███▃▃▂▂▂▂▂▂▂▂▃▃▄▃▄▃▃▂▂▂▃▄▄▄▃▃▃▃▃▃▂▂▂▂▂▂▂▂▂▂▂▂▂▁▂▁▂▂▂▂▂▂ ▃
  40.4 ns         Histogram: frequency by time         55.7 ns <
...
BenchmarkTools.Trial: 10000 samples with 997 evaluations.
 Range (min … max):  21.463 ns …  20.108 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):     23.270 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   57.616 ns ± 585.969 ns  ┊ GC (mean ± σ):  0.68% ± 1.38%

         ▄█▄                                                    
  ▁▁▂▂▃▄▇███▇▃▂▁▁▁▁▁▁▁▁▁▂▂▂▂▂▂▂▁▁▁▁▁▁▁▁▂▂▂▃▄▃▃▂▂▂▂▂▂▂▁▁▁▁▁▁▁▁▁ ▂
  21.5 ns         Histogram: frequency by time         33.2 ns <
